...
public class CameraFollow : MonoBehaviour {
 ...
 //GameObject transform holding reference to the player.
    ...
    void Awake() {
        ...
        myCol.size = new Vector2 (Camera.main.aspect * 2f * Camera.main.orthographicSize,   
 15f);
 ...
 // Replace "Player" with the actual name of your player GameObject
